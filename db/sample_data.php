...
use \Company\Models\EmployeeModel;
use \Company\Models\DepartmentModel;
use \Company\Models\DeptEmpModel;
use \Company\Models\DeptManagerModel;
use \Company\Models\TitlesModel;
use \Company\Models\SalariesModel;

use \Company\Mappers\EmployeeMapper;
use \Company\Mappers\DepartmentMapper;
use \Company\Mappers\DeptEmpMapper;
use \Company\Mappers\DeptManagerMapper;
use \Company\Mappers\TitlesMapper;
use \Company\Mappers\SalariesMapper;

dataFillDepartments();
dataFillEmployees(10);
dataFillDeptEmp(10);
dataFillDeptManager(6);
dataFillTitles(10);
dataFillSalaries(10);
